...
namespace Jacquesndl\EasyAdminPlusBundle\Entity;
 ...
 *
 * @ORM\Entity(repositoryClass="Jacquesndl\EasyAdminPlusBundle\Repository\UserRepository")
 * @ORM\Table(name="jacquesndl_easy_admin_plus_user")
